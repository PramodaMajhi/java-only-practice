...
/*
        ...
        at the index (i+k)%length of the array, then we can copy the new array to original one.
    ...
    /*
        ...
        keep last element in temp variable. and shift last element with previous element,
